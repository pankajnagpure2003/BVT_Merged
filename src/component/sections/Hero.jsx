...
function Hero() {
  return (
    <section id="top" className="relative flex min-h-screen items-center overflow-hidden px-4 pb-14 pt-24 sm:px-6 lg:px-8">
      <BackgroundFX dense />
  ...
  PRESALE
        ...
        <motion.div initial={{ opacity: 0, scale: .82, rotate: -4 }} animate={{ opacity: 1, scale: 1, rotate: 0 }}
          ...
          <div className="relative animate-float">
            <img src={SITE.logo} alt="Bhavishya Vision Token logo" className="relative z-10 mx-auto w-[78%] drop-shadow-[0_0_35px_rgba(212,175,55,.32)] sm:w-[86%]" />
